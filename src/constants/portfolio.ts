...
export const portfolioList: Portfolio[] = [
  ...
  },
  {
    ...
    description:
      "For Website Counting system to features dashboard, order, schedule, counting monitor",
    livePreviewURL: "",
    repositoryURL: "",
    techStack: [
      {
  ...
  {
    title: "Tanskin Ecommerce",
    imageThumbnail: "/assets/images/tanskin.png",
    description:
    ...
    livePreviewURL: "https://tanskin.id/",
    repositoryURL: "",
    techStack: [
      {
        tech: "Codeigneter",
        logo: "/assets/svg/codeigneter.svg",
      },
      {
        tech: "Tailwind",
  ...
  },
  {
    ...
    imageThumbnail: "/assets/images/porto.png",
    description:
  ...
  {
    title: "CRM Web",
    imageThumbnail: "/assets/images/crm.png",
    description:
      "Crm is a website that I created using laravel, php, mysql, python ai. This website to help proven force indonesia to hadlle customer to feature calls, contact, email marketing, ai, calls history.",
    livePreviewURL: "https://superapp-provenforceindonesia.com/",
    repositoryURL: "",
    techStack: [
      {
        tech: "Laravel",
  ...
  {
    title: "Blackwood",
    imageThumbnail: "/assets/images/blackwood.png",
    description:
      "blackwood is a website that I created using Laravel, mysql, bootrap. This website displays information about Catalog and Products. The website provides information about the company, its products, and services. The website also provides a contact form for users to get in touch with the company. The website is designed to be user-friendly and easy to navigate. The website is optimized for mobile devices and is responsive.",
    livePreviewURL: "https://blackwood.id/",
    repositoryURL: "",
    techStack: [
      {
        tech: "Laravel",
  ...
  },
  {
    ...
    description:
      "HooBank is a website that I created using codeigneter, mysql, bootstrap. This website displays information about a company that operates in the field of financial digitalization, such as payment, transfer, and online investment services. This website also has security, convenience, and ease features that make it easy for users to manage their finances digitally.",
    livePreviewURL: "https://abditrack.com/",
    repositoryURL: "",
    techStack: [
      {
        tech: "Codeigneter",
